...
if(isset($_POST['updaterec'])){
    $user_id = secure($_POST['matric_no']);
    $fullname = secure($_POST['fullname']);
    $email = secure($_POST['email']);
    if(!empty($fullname) || !empty($email)){
        try{
        $chk = update_prof_std($fullname, $email, $user_id);
            if($chk==true){
                ...
                <div class="row">
                    <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                        <div class="d-flex align-items-center flex-row flex-wrap">
                            ...
                            <div class="">
                                <h5 class="fw-semibold fs-22 mb-1"><?php echo $matric; ?></h5>                                                        
                                <p class="mb-0 text-muted fw-medium"><?php echo 'Student'; ?></p>                                                        
                            </div>
                        </div>                                                
                    </div><!--end col-->
