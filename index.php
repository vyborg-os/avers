   ...
   if (isset($_POST["loguser"])) {
    ...
    if (empty($matric) || empty($pass)) {
        ...
        if ($chk==true) {
            ...
            $error =  'Student info does not exist';
        }
        } catch(Exception $e){
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                            <div class="card">
                                <div class="card-body p-0 bg-default auth-header-box rounded-top" style="background-color: blue;">
                                    <div class="text-center p-3">
                                        <a href="#" class="logo logo-admin">
                                            <img src="assets/images/logo-sm.png" height="50" alt="logo" class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">AVERS AAUA</h4>   
                                        <p class="text-white fw-medium mb-0">Student Login...</p>  
                                    </div>
                                </div>
                                ...
                                ?>                                    
                                    <form class="my-4" action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">            
                                        <div class="form-group mb-2">
                                            <label class="form-label" for="username">Matric Number</label>
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12">
                                                ...
                                                <center><a class="btn btn-blue mt-2" style="background-color: lightgrey;" href="./staff/">Staff Login</a></center>
                                            </div><!--end col--> 
                                        </div> <!--end form-group-->                           
                                    </form><!--end form-->
                                </div><!--end card-body-->
