...
//include_once('session.php');
   if (isset($_POST["loguser"])) {
    ...
    if (empty($username) || empty($pass)) {
        ...
        if ($chk==true) {
            $stmt = $mysqli->prepare("SELECT * FROM admin WHERE email = ? || username = ? ");
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                            <div class="card">
                                <div class="card-body p-0 bg-danger auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        <a href="#" class="logo logo-admin">
                                            <img src="../assets/images/logo-sm.png" height="50" alt="logo" class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">Avers AAUA</h4>   
                                        <p class="text-white fw-medium mb-0">ADMIN Sign-in Section.</p>  
                                    </div>
                                </div>
